...
if __name__ == '__main__':
    ...
    bag_fps = sorted([x for x in os.listdir(args.src_dir) if '.bag' in x])
    ...
    typestore = get_typestore(Stores.ROS1_NOETIC)  # Or Stores.ROS1_MELODIC depending on your messages
