...
if __name__ == '__main__':
    ...
    left_out_dir = os.path.join(args.dataset, SENSORS_GROUP, f"{config['left_dir']}_{config['output_suffix']}")
    right_out_dir = os.path.join(args.dataset, SENSORS_GROUP, f"{config['right_dir']}_{config['output_suffix']}")
    os.makedirs(left_out_dir, exist_ok=True)
    os.makedirs(right_out_dir, exist_ok=True)

    left_camera_info_out_dir = os.path.join(args.dataset, SENSORS_GROUP, f"{config['left_dir']}_{config['output_suffix']}_camera_info")
    right_camera_info_out_dir = os.path.join(args.dataset, SENSORS_GROUP, f"{config['right_dir']}_{config['output_suffix']}_camera_info")
